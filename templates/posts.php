                ...
                <div class="col">
                    <div class="blog_post_container">
                        ...
                        <div class="blog_post trans_200">
                            <div class="blog_post_image"><img src="<?php echo BASE_URI ?>images/blog/<?php echo (!empty($posts->post_featured_img))? $posts->post_featured_img : 'dumy_img.jpg'?>" alt=""></div>
                            <div class="blog_post_body">
                                <div class="blog_post_title"><a href="blog_single.html"><?php echo $posts->post_title ?></a></div>
